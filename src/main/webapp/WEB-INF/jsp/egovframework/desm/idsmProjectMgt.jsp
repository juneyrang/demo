...
<%
    ...
    String idsmProjectMgtJs = "/resources/scripts/idsmProjectMgt.js?rv=" + rV;
%>
...
<script src="/resources/scripts/idsmProjectMgt.js"	></script> --%>
<script src="<%= ajaxSetupJs %>"></script>
<script src="<%= idsmProjectMgtJs %>"></script>
				...
				<div class="container-fluid">
					...
					<div class="row row-sm">
						<div id="divUserGird" class="col-sm-6 col-xl-6 col-lg-6" style="padding-right:0; padding-left:0">
							<div id="gridIdsmProjectMgtUser" style="padding-top:1px; width:100%; height:600px;"></div>
						</div>
						<div id="divProjectGird" class="col-sm-6 col-xl-6 col-lg-6" style="padding-right:0">
							<div id="gridIdsmProjectMgtProject" style="padding-top:1px; width:100%; height:600px;"></div>
						</div>						
					</div>
				</div>
