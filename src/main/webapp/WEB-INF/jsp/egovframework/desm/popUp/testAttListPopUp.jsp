...
<%
    ...
    String testAttListPopUpJs = "/resources/scripts/popUp/testAttListPopUp.js?rv=" + rV;
%>

<%--<script src="/resources/scripts/popUp/testAttListPopUp.js"	></script> --%>
<script src="<%= testAttListPopUpJs %>"></script>
	...
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="max-width: 600px;">
		<div class="modal-content">
			<div class="modal-header">
				<h6 class="modal-title" id="dlgAttListTitle">Attachment</h6>
			...
			<div class="modal-footer">
				<button id="btnDlgAttListSave" authType="AttS" class="btn btn-success btn-icon-split btn-sm">
