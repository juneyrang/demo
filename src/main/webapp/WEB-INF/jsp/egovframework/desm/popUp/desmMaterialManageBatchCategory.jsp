...
<div class="modal hide fade" id="desmMaterialManageBatchCATEGORY" tabindex="-1" role="dialog" aria-labelledby="dlgPortTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false" style="z-index:1100">
				...
				<div class="container-fluid" style="padding-right: 4px;padding-left: 4px;">
					<div class="form-group row mb-1">
						...
						<div class="col-sm-10" style="padding-right:0">
							<input id="desmMaterialManageBatchValueCATEGORY" class="form-control form-control-user"  />
						</div>
					</div>
				</div>
			</div>
