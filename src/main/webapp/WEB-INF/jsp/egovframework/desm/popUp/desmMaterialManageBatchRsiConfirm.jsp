...
<div class="modal hide fade" id="desmMaterialManageBatchIS_RSI_CONFIRM" tabindex="-1" role="dialog" aria-labelledby="dlgPortTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false" style="z-index:1100">
				...
				<div class="container-fluid" style="padding-right: 4px;padding-left: 4px;">
					<div class="form-group row mb-1">
						...
						<div class="col-sm-10" style="padding-right:0">
							<select id="desmMaterialManageBatchValueIS_RSI_CONFIRM" class="form-control form-control-user">
