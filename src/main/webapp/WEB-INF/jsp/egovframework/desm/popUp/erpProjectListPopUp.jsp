...
<%
    ...
    String erpProjectListPopUpJs = "/resources/scripts/popUp/erpProjectListPopUp.js?rv=" + rV;
%>

<%--<script src="/resources/scripts/popUp/erpProjectListPopUp.js"	></script> --%>
<script src="<%= erpProjectListPopUpJs %>"></script>
...
<input id="alertDlgProjectListGridSelectDataNull"		type="hidden" value="<spring:message code='alert.grid.select.data.null'	/>"/>