...
<%
    ...
    String desmMrrPlDtlPopUpJs = "/resources/scripts/popUp/desmMrrPlDtlPopUp.js?rv=" + rV;
%>
...
<%--<script src="/resources/scripts/popUp/desmMrrPlDtlPopUp.js"	></script> --%>
<script src="<%= desmMrrPlDtlPopUpJs %>"></script>
...
<div class="modal hide fade" id="dlgDesmMrrPlDtl" tabindex="-1" role="dialog" aria-labelledby="dlgDesmMrrPlDtlTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false" style="z-index:1100">
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="max-width: 96%;">
		<div class="modal-content">
			<div class="modal-header">
				<h6 class="modal-title" id="dlgDesmMrrPlDtlTitle">MRR Package List</h6>
				...
				<div class="card-body-grid" style="vertical-align: middle; ">
					<div class="table-responsive" style="vertical-align: middle; ">
						<table border="0"width="100%" style="border: 1px solid #d1d3e2; margin-bottom: 0.2rem;">
							<tr>
								<td width="100%">
									<table border="0" style="height: 43px;" id="tblDlgDesmMrrPlDtlSearchBox">
									  <colgroup>
									    <col style="width: 9%;" />
									    <col style="width: 5%;" />
									    <col style="width: 10%;" />
										...
										<tr>
											...
											<td >
												<input id="txtDlgDesmMrrPlDtlProjectCode" type="text" class="form-control form-control-user required" autocomplete="off" readonly>

												</input>
											</td>
											<td>
												<input id="txtDlgDesmMrrPlDtlProjectName" type="text" class="form-control form-control-user required"  readonly/>
											</td>
											...
											<td>
												<input id="txtDlgDesmMrrPlDtlInvoiceNo" type="text" class="form-control form-control-user " autocomplete="off">
											</td>
										...
										<tr>
											...
											<td colspan="2">
												<input id="txtDlgDesmMrrPlDtlPackageNo" type="text" class="form-control form-control-user " autocomplete="off">
											</td>
									...
									<table border="0" style="width: 100%; height: 72px;">
										<tr>
											<td style="vertical-align:middle; text-align:right; padding-bottom:1px; " width="100%">
												<button id="btnDlgDesmMrrPlDtlSearch" authType="R" class="btn btn-primary btn-icon-split" role="button" style="width:80px; background-color:#4599EE !important; margin-top: 2px;height: 44px;">
										...
										<tr>
											<td style="vertical-align:middle; text-align:right; padding-top:1px;" width="100%">
												<button id="btnDlgDesmMrrPlDtlResete" authType="R" class="btn btn-primary btn-icon-split" role="button" style="width:80px; background-color:#BEC2C6 !important; color: #000000;height: 22px; margin-bottom: 2px">
						...
						<div id="dlgDesmMrrPlDtlGrid" style="padding-top: 4px; height:550px;" ></div>
					</div>
				</div>
			</div>

			<div class="modal-footer">
				<button id="btnDlgDesmMrrPlDtlCompletion" class="btn btn-success btn-icon-split btn-sm">
...
<div id="dlgDesmMrrPlDtlPopUp"></div>