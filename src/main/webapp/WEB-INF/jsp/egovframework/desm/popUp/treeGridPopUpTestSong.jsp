<!--
	기자재 일정관리 > 기자재 일정관리 > 목록 > 팝업( 높이조정 버전 )
-->
...
<script src="/resources/scripts/popUp/treeGridPopUpTestSong.js"></script>
...
img.ui-datepicker-trigger { float:right; margin-top:calc(-2.7em + 5px); margin-right:2px; cursor:pointer; }
	...
	<div class="row row-sm">
		<div class="col-sm-6 col-xl-6 col-lg-6">
			...
			<div class="card shadow mb-2">
				<div class="card-header py-1" style="padding-top:2px; padding-bottom:2px"><!-- style="padding-top:2px; padding-bottom:2px" -->
					<h6 class="m-0 font-weight-bold text-primary">Item 일정 및 Issue 관리</h6>
				</div>
				<div class="card-body" style="padding: 0px"><!-- style="padding: 0px" -->
			...
			<div class="card shadow mb-2">
				<div class="card-header py-0" style="padding-top:2px; padding-bottom:2px"><!-- <div class="card-header py-2"> -->
					...
					<button id="btnMenuModalDelete" class="btn btn-danger btn-icon-split btn-sm" role="button" style="float: right; height: 25px">
						...
						<span class="text" style="font-size:0.8em">삭제</span><!-- style="font-size:0.8em" -->
					</button>
					<button id="btnAdd" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float: right; margin-right : 4px; height: 25px">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text" style="font-size:0.8em">추가</span><!-- style="font-size:0.8em" -->
					</button>
					...
					<div class="card shadow mb-2">
						<div class="card-header py-0" style="padding-top:2px; padding-bottom:2px"><!-- <div class="card-header py-2"> -->
							...
							<button id="btnAdd" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; height: 25px"">
								<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
								<span class="text" style="font-size:0.8em">일정수정</span><!-- style="font-size:0.8em" -->
							</button>
						...
						<div class="card-body">
							<div class="form-group row mb-1">
								...
								<div class="col-sm-6">
									<input id="date1" name="popDate" type="text" class="form-control form-control-user " >
								</div>
							</div>
							<div class="form-group row mb-1">
								<div class="col-sm-4 text-left font-weight-bold">
								...
								<div class="col-sm-6">
									<input id="date2" name="popDate" type="text" class="form-control form-control-user " >
								</div>
							</div>
							<div class="form-group row mb-1">
								<div class="col-sm-4 text-left font-weight-bold">
								...
								<div class="col-sm-6">
									<input id="date3" name="popDate" type="text" class="form-control form-control-user " >
								</div>
							</div>
							<hr class="m-1" />
							<div class="form-group row mb-1">
							...
							<div class="form-group row mb-1">
								...
								<div class="col-sm-6">
									<input id="date11" name="popDate" type="text" class="form-control form-control-user " >
								</div>
							</div>
							<div class="form-group row mb-1">
								<div class="col-sm-4 text-left font-weight-bold">
								...
								<div class="col-sm-6">
									<input id="date22" name="popDate" type="text" class="form-control form-control-user " >
								</div>
							</div>
							<div class="form-group row mb-1">
								<div class="col-sm-4 text-left font-weight-bold">
								...
								<div class="col-sm-6">
									<input id="date33" name="popDate" type="text" class="form-control form-control-user " >
								</div>
							</div>
							<hr class="m-1" />
							<div class="form-group row mb-1">
							...
							<div class="form-group row mb-1">
								...
								<div class="col-sm-6">
									<input id="date111" name="popDate" type="text" class="form-control form-control-user " readonly>
								</div>
							</div>
							<div class="form-group row mb-1">
								<div class="col-sm-4 text-left font-weight-bold">
								...
								<div class="col-sm-6">
									<input id="date222" name="popDate" type="text" class="form-control form-control-user " >
								</div>
							</div>
							<div class="form-group row mb-1">
								<div class="col-sm-4 text-left font-weight-bold">
								...
								<div class="col-sm-6">
									<input id="date333" name="popDate" type="text" class="form-control form-control-user " >
								</div>
							</div>
							<hr class="m-1" />
							<div class="form-group row mb-1">
							...
							<div class="form-group row mb-1">
								...
								<div class="col-sm-6">
									<input id="date1111" name="popDate" type="text" class="form-control form-control-user " >
								</div>
							</div>
							<div class="form-group row mb-1">
								<div class="col-sm-4 text-left font-weight-bold">
								...
								<div class="col-sm-6">
									<input id="date2222" name="popDate" type="text" class="form-control form-control-user " >
								</div>
							</div>
							<div class="form-group row mb-1">
								<div class="col-sm-4 text-left font-weight-bold">
								...
								<div class="col-sm-6">
									<input id="date3333" name="popDate" type="text" class="form-control form-control-user " >
								</div>
							</div>
							<hr class="m-1" />
							<div class="form-group row mb-1">
							...
							<div class="form-group row mb-1">
								...
								<div class="col-sm-6">
									<input id="date11111" name="popDate" type="text" class="form-control form-control-user " >
								</div>
							</div>
							<div class="form-group row mb-1">
								<div class="col-sm-4 text-left font-weight-bold">
								...
								<div class="col-sm-6">
									<input id="date22222" name="popDate" type="text" class="form-control form-control-user " >
								</div>
							</div>
							<div class="form-group row mb-1">
								<div class="col-sm-4 text-left font-weight-bold">
								...
								<div class="col-sm-6">
									<input id="date33333" name="popDate" type="text" class="form-control form-control-user " >
								</div>
							</div>
						</div>
					</div>
