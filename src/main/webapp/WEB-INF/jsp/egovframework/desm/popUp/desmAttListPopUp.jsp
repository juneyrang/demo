...
<%
    ...
    String desmAttListPopUpJs = "/resources/scripts/popUp/desmAttListPopUp.js?rv=" + rV;
%>

<%--<script src="/resources/scripts/popUp/desmAttListPopUp.js"	></script> --%>
<script src="<%= desmAttListPopUpJs %>"></script>
