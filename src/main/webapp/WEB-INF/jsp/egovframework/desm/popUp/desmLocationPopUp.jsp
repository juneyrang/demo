...
<%
    ...
    String desmLocationPopUpJs = "/resources/scripts/popUp/desmLocationPopUp.js?rv=" + rV;
%>

<%--<script src="/resources/scripts/popUp/desmLocationPopUp.js"	></script> --%>
<script src="<%= desmLocationPopUpJs %>"></script>
