...
<div class="modal hide fade" id="desmMaterialManageBatchEXPIRED_DATE" tabindex="-1" role="dialog" aria-labelledby="dlgPortTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false" style="z-index:1100">
				...
				<div class="container-fluid" style="padding-right: 4px;padding-left: 4px;">
					<div class="form-group row mb-1">
						<div class="col-sm-4 text-right font-weight-bold">
							<label class="" style="line-height : 2">Expired Date</label>
						</div>
						<div class="col-sm-8" >
							<input id="desmMaterialManageBatchValueEXPIRED_DATE" type="text" name="inpDatePicker" class="form-control form-control-user"  autocomplete="off" />
						</div>
					</div>
				</div>
			</div>
