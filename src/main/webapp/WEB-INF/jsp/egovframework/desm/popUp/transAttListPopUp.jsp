...
<%
    ...
    String transAttListPopUpJs = "/resources/scripts/popUp/transAttListPopUp.js?rv=" + rV;
%>

<%--<script src="/resources/scripts/popUp/transAttListPopUp.js"	></script> --%>
<script src="<%= transAttListPopUpJs %>"></script>
	...
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="max-width: 600px;">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button id="btnDlgAttListSave" authType="S" class="btn btn-success btn-icon-split btn-sm">
