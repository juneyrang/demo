...
<%
    ...
    String transShippingRequestJs = "/resources/scripts/transShippingRequest.js?rv=" + rV;
%>
...
<script src="/resources/scripts/transShippingRequest.js"	></script> --%>
<script src="<%= ajaxSetupJs %>"></script>
<script src="<%= transShippingRequestJs %>"></script>
		...
		<div class="card-body-grid" style="vertical-align: middle; ">
			...
			<div class="table-responsive" style="vertical-align: middle; ">
						...
						<td width="100%">
							<table id="tblSearchBox" style="height: 43px;border : 0">		
								...
								<tr>
									...
									<td >
										<input id="txtSearchProject" type="text" class="form-control form-control-user" autocomplete="off" />
									...
									<td style = "text-align: right; padding-right : 4px">
										<label class="" style="">요청번호</label>
									</td>
									<td >
										<input id="txtSearchShippingReqNo" type="text" class="form-control form-control-user"  autocomplete="off" />
									</td>									
									<td style = "text-align: right; padding-right : 4px">
								...
								<tr>
									<td style = "text-align: right; padding-right : 4px">
										<label class="" style="">출하 예정일</label>
									</td>
									<td colspan="2" style="padding:0" >
										<table  style="width:100%; border:0">
											<tr>	
												<td style="width:174px">
													<input id="txtSearchFromSoDate" name="inpDatePicker" type="text" class="form-control form-control-user" style="text-align: center" autocomplete="off" />
												</td>
												<td style="width:2px">~</td>
												<td style="width:174px">
													<input id="txtSearchToSoDate" name="inpDatePicker" type="text" class="form-control form-control-user" style="text-align: center" autocomplete="off" />
												</td>												
											</tr>
										</table>
									</td>																									
									<td style = "text-align: right; padding-right : 4px">
										<label class="" style = "">요청상태</label>
									</td>
									<td>
										<select id="txtSearchStatus" class="form-control form-control-user" style="background-color: #B4D9FD;" >
										</select>
									</td>
									
									<td style = "text-align: right; padding-right : 4px">
										<label class="" >Vendor 명</label>
									</td>
									<td>
										<input id="txtSearchVendorName" type="text" class="form-control form-control-user"  autocomplete="off" />
									</td>
									
									<td style = "text-align: right; padding-right : 4px">
										<label class="" style = "">구매인도조건</label>
									</td>
									<td>
										<select id="txtSearchDeliveryTerms" class="form-control form-control-user" style="background-color: #B4D9FD;" >
										</select>
									</td>
				...
				<div id="toolbar" style="margin-bottom: 1px; padding-right: 1px;">
					...
					<button id="btnEdit" authType="S" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text">신규출하요청</span>
					</button>
...
<div id="divtransShippingRequestPopUp"></div>
