...
<%
    ...
    String idsmSchmapJs = "/resources/scripts/idsmSchmap.js?rv=" + rV;
%>
...
<script src="/resources/scripts/idsmSchmap.js"	></script> --%>
<script src="<%= ajaxSetupJs %>"></script>
<script src="<%= idsmSchmapJs %>"></script>
		...
		<div class="card-body-grid" style="vertical-align: middle; ">
			<div class="table-responsive" style="vertical-align: middle; ">
							...
							<table border="0" id="tblSearchBox" style="height: 43px;">
							  <colgroup>
								...
								<tr>
									...
									<td >
										<input id="txtProjectCode" type="text" class="form-control form-control-user required" autocomplete="off">
									...
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">Item1</label>
									</td>
									<td colspan = "2">
										<input id="txtItem1" type="text" class="form-control form-control-user " autocomplete="off">
									</td>
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">Item2</label>
									</td>
									<td colspan = "2">
										<input id="txtItem2" type="text" class="form-control form-control-user " autocomplete="off">
									</td>									
								</tr>
								<tr>
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">Item3</label>
									</td>
									<td colspan = "2">
										<input id="txtItem3" type="text" class="form-control form-control-user " autocomplete="off">
									</td>
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">Item4</label>
									</td>
									<td colspan = "2">
										<input id="txtItem4" type="text" class="form-control form-control-user " autocomplete="off">
									</td>	
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">Task Code</label>
									</td>
									<td >
										<input id="txtTaskCode" type="text" class="form-control form-control-user " autocomplete="off">
									</td>	
									<td>
										<span style="float:left;margin-left:20px">미 입력 Task</span><input id="chkItem" type="checkbox" class="form-control form-control-user" style="float:left;margin-top:1px;margin-left:6px">
									</td>																	
								</tr>
							</table>
						</td>
				...
				<div id="toolbar" style="margin-bottom: 1px; padding-right: 1px;">
					<span id="spanInfo" style="height: 23px;color:#000000">▶신규생성 대상 건수 : 0건 , ▶삭제 대상 건수 : 0건</span>	
					...
					<button id="btnNewData" authType="S" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-clone"></i></span>
						<span class="text"><spring:message code='button.schmap.new.data'/></span>
					</button>										
					
					<button id="btnSyncData" authType="S" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-clone"></i></span>
						<span class="text"><spring:message code='button.schmap.sync.data'/></span>
					</button>					
				...
				<div id="gridIdsmSchmap" style="padding-top:1px; width:1000px; height:600px;"></div>
