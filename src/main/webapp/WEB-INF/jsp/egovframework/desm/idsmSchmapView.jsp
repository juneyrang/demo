...
<%
    ...
    String idsmSchmapViewJs = "/resources/scripts/idsmSchmapView.js?rv=" + rV;
%>
...
<script src="/resources/scripts/idsmSchmapView.js"	></script> --%>
<script src="<%= ajaxSetupJs %>"></script>
<script src="<%= idsmSchmapViewJs %>"></script>
			...
			<div class="table-responsive" style="vertical-align: middle; ">
				...
				<div id="toolbar" style="margin-bottom: 1px; padding-right: 1px;">
					...
					<button id="btnSyncData" authType="S" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						...
						<span class="text"><spring:message code='button.schmap.sync.date'/></span>
					</button>	

				</div>

				<div id="gridIdsmSchmapView" style="padding-top:1px; width:1000px; height:600px;"></div>
...
<div id="dlgIdsmSchmapViewPopUp"></div>
