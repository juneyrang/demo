...
<%
    ...
    String idsmSetupJs = "/resources/scripts/idsmSetup.js?rv=" + rV;
%>
...
<script src="/resources/scripts/idsmSetup.js"	></script> --%>
<script src="<%= ajaxSetupJs %>"></script>
<script src="<%= idsmSetupJs %>"></script>
		...
		<div class="card-body-grid" style="vertical-align: middle; ">
			<div class="table-responsive" style="vertical-align: middle; ">
				...
				<div id="toolbar" style="margin-bottom: 1px; padding-right: 1px;">
					...
					<button id="btnInvoiceMng" authType="S"  class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text"><spring:message code='button.invoice.seq.mng'/></span>
					</button>					
...
<!-- 						<div class="col-sm-7 col-xl-7 col-lg-7" > -->
							...
							<div class="card shadow mb-2">
								<div class="card-header py-1" style="padding-top:2px; padding-bottom:2px">
									<h7 class="m-0 font-weight-bold text-primary" style="padding-top: 4px; float: left;"><spring:message code='modal.create.item.item.user.label'	/></h7>
						...
						<div class="col-sm-7 col-xl-7 col-lg-7" >
							...
							<div class="card shadow mb-2">
								<div class="card-header py-1" style="padding-top:2px; padding-bottom:2px; padding-bottom: 0rem !important; padding-top: 0rem !important; vertical-align: middle;">
									<label class="font-weight-bold text-primary" style="vertical-align: middle;position: absolute; margin-top: 5px"><spring:message code='modal.create.item.item.user.label'/></label>
									...
									<div class="card shadow mb-2">
										...
										<div class="card-body" style="padding: 1px">
											...
											<div class="form-group row mb-1">
												...
												<div class="col-sm-3 text-max-min-width">
													<input id="txtDlgItemScheduleCargoPlanDate" type="text" class="form-control form-control-user " >
												</div>
											</div>
											<div class="form-group row mb-1">
												<div class="col-sm-2 text-left font-weight-bold label-max-min-width">
