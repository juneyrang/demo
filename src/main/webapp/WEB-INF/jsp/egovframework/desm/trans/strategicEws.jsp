...
<%
    ...
    String strategicEwsJs = "/resources/scripts/trans/strategicEws.js?rv=" + rV;
%>
...
<script src="<%= strategicEwsJs %>"></script>
		...
		<div class="card-body-grid" style="vertical-align: middle; ">
			<div class="table-responsive" style="vertical-align: middle; ">
							...
							<table border="0" id="tblSearchBox" style="height: 28px;">
								...
								<tr>
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">EWS Name</label>
									</td>
									<td>
										<select id="selStrategicEwsName" class="form-control form-control-user" style="background-color: #B4D9FD;">
				...
				<div class="container-fluid">
					...
					<div class="row row-sm">
						<div id="gridStrategicEws" style="padding-top:1px; width:100%; height:600px;"></div>						
					</div>
				</div>
...
<div id="dlgStrategicEwsPopUp"></div>
