...
<%
    ...
    String shippingMarkJs = "/resources/scripts/mpr/shippingMark.js?rv=" + rV;
%>
...
<script src="/resources/scripts/mpr/shippingMark.js"	></script> --%>
<script src="<%= ajaxSetupJs %>"></script>
<script src="<%= shippingMarkJs %>"></script>
		...
		<div class="card-body-grid" style="vertical-align: middle; ">
			<div class="table-responsive" style="vertical-align: middle; ">
							...
							<table border="0" id="tblSearchBox" style="height: 43px;">
							  <colgroup>
								...
								<tr>
									...
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">Date</label>
									</td>
									<td >
										<input id="txtStartDate" name="inpDatePicker" type="text" class="form-control form-control-user" placeholder="" title="" style="width:100%; text-align: center; " autocomplete="off"/>										
									</td>
									<td style="text-align: center">
										<label class="" style="">~</label>
									</td>
									<td >										
										<input id="txtEndDate" name="inpDatePicker" type="text" class="form-control form-control-user" placeholder="" title="" style="width:100%;text-align: center ;" autocomplete="off"/>
									</td>										
				...
				<div id="toolbar" style="margin-bottom: 1px; padding-right: 1px;">
					...
					<button id="btnCreation" authType="S" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text">Shipping Mark Creation</span>
					</button>
					...
					<button id="btnReport" authType="R" class="btn btn-success btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-file"></i></span>
						<span class="text">Report</span>
					</button>				
				</div>

				<div id="gridDesmShippingMark" style="padding-top:1px; width:1000px; height:600px;"></div>
...
<div id="desmShippingMarkPopUp"></div>
