...
<%
    ...
    String mprSupplierSetupJs = "/resources/scripts/mpr/mprSupplierSetup.js?rv=" + rV;
%>
...
<script src="/resources/scripts/mpr/mprSupplierSetup.js"	></script> --%>
<script src="<%= ajaxSetupJs %>"></script>
<script src="<%= mprSupplierSetupJs %>"></script>
		...
		<div class="card-body-grid" style="vertical-align: middle; ">
			<div class="table-responsive" style="vertical-align: middle; ">
							...
							<table border="0" id="tblSearchBox" style="height: 43px;">
							  <colgroup>
								...
								<tr>
									...
									<td >
										<input id="txtSupplierName" type="text" class="form-control form-control-user " style="width: 100%;" autocomplete="off">
									</td>									
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">Supplier No.</label>
									</td>
									<td >
										<input id="txtSupplierNo" type="text" class="form-control form-control-user " style="width: 100%;" autocomplete="off">
									</td>
								...
								<tr>
									<td style="vertical-align:middle; text-align:right; padding-bottom:1px; " width="100%">
										<button id="btnSearch" authType="R" class="btn btn-primary btn-icon-split" role="button" style="width:80px; background-color:#4599EE !important; margin-top: 0.5px;height: 22px;">
											<span class="icon" style="padding:0.19rem 0.3rem 0.375rem 0.75rem;">
				...
				<div id="toolbar" style="margin-bottom: 1px; padding-right: 1px;">
					...
					<button id="btnDelelte" authType="S" class="btn btn-danger btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
					...
					<button id="btnSetup" authType="S" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text">Supplier Setup</span>
					</button>
				</div>

				<div id="gridDesmMprSupplierSetup" style="padding-top:1px; width:1000px; height:600px;"></div>
...
<div id="desmMprSupplierSetuppPopUp"></div>
