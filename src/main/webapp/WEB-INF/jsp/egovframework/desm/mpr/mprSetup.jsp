...
<%
    ...
    String mprSetupJs = "/resources/scripts/mpr/mprSetup.js?rv=" + rV;
%>
...
<script src="/resources/scripts/mpr/mprSetup.js"	></script> --%>
<script src="<%= ajaxSetupJs %>"></script>
<script src="<%= mprSetupJs %>"></script>
		...
		<div class="card-body-grid" style="vertical-align: middle; ">
			<div class="table-responsive" style="vertical-align: middle; ">
							...
							<table border="0" id="tblSearchBox" style="height: 43px;">
							  <colgroup>
								...
								<tr>
									...
									<td >
										<input id="txtSupplier" type="text" class="form-control form-control-user " style="width: 100%;float:left" autocomplete="off">
										<input id="txtSupplierNo" type="text" class="form-control form-control-user" style="width: 40%;display:none;float:left;margin-left:4px" autocomplete="off" readonly>
									</td>
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">Update Date</label>
									</td>
									<td >
										<input id="txtStartUpdateDate" name="inpDatePicker" type="text" class="form-control form-control-user" placeholder="" title="" style="width:100%; text-align: center; " autocomplete="off"/>										
									</td>
									<td style="text-align: center">
										<label class="" style="">~</label>
									</td>
									<td >										
										<input id="txtEndUpdateDate" name="inpDatePicker" type="text" class="form-control form-control-user" placeholder="" title="" style="width:100%;text-align: center ;" autocomplete="off"/>
									</td>										
								...
								<tr>
									...
									<td >
										<input id="txtExpediter" type="text" class="form-control form-control-user " style="width: 100%;float:left" autocomplete="off">
									</td>
				...
				<div id="toolbar" style="margin-bottom: 1px; padding-right: 1px;">
					...
					<button id="btnMPRSetup" authType="S" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text">New MPR Setup</span>
					</button>
					<button id="btnMPRSetupDelete" authType="S" class="btn btn-danger btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-trash"></i></span>
						<span class="text">Delete</span>
					</button>
					<button id="btnManualPoCreation" authType="S" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px; display:none;">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text">Manual PO Creation</span>
					</button>					
						
				</div>

				<div id="gridDesmMprSetup" style="padding-top:1px; width:1000px; height:600px;"></div>
