...
<%
    ...
    String plMapJs = "/resources/scripts/material/plMap.js?rv=" + rV;
%>
...
<script src="/resources/scripts/material/plMap.js"	></script> --%>
<script src="<%= ajaxSetupJs %>"></script>
<script src="<%= plMapJs %>"></script>
		...
		<div class="card-body-grid" style="vertical-align: middle; ">
			<div class="table-responsive" style="vertical-align: middle; ">
							...
							<table border="0" id="tblSearchBox" style="height: 28px;">
							  <colgroup>
								...
								<tr>
									...
									<td>
										<select id="selMapName" class="form-control form-control-user" style="background-color: #B4D9FD;">
											<option value=''>Select</option>
										</select>
									</td>
									<td colspan="7" style="text-align: right; padding-right: 10px"><span id="spanPjtTotal"></span></td> <!-- Totel Pkg(EA) :  Total NET : Total Gross : Total SQM -->
								</tr>
							</table>
						</td>
				...
				<div id="toolbar" style="margin-bottom: 1px; padding-right: 1px;">
					...
					<button id="btnMapCancle" authType="S" class="btn btn-secondary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-window-close"></i></span>
						<span class="text">Cancle</span>
					</button>

					<button id="btnMapReset" authType="S" class="btn btn-secondary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-sync"></i></span>
						<span class="text">Reset</span>
					</button>

					<button id="btnMapSave" authType="S" class="btn btn-success btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-save"></i></span>
						<span class="text">Save</span>
					</button>


					<button id="btnMapDelete" authType="S" class="btn btn-danger btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-trash"></i></span>
						<span class="text">Delete</span>
					</button>

					<button id="btnMapLineAdd" authType="S" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text">Line Add</span>
					</button>

					<button id="btnMapAreaAdd" authType="S" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text">Area Add</span>
					</button>

					<button id="btnMapCreation" authType="S" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text">Map Creation</span>
					</button>

					<button id="btnMapDetailInfo" authType="R" class="btn btn-info btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-file"></i></span>
						<span class="text">Material Detail list</span>
					</button>

					<button id="btnMapPackageInfo" authType="R" class="btn btn-info btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-file"></i></span>
						<span class="text">Material Package list</span>
					</button>
				</div>

			</div>
			<hr class="m-1" style="margin-top:4px !important; padding-bottom : 4px" />
			<canvas id="canvas" height="700" width="1200" style="" ></canvas>
		</div>
	</div>
</div>

<div id="dlgMapPopUp"></div>
