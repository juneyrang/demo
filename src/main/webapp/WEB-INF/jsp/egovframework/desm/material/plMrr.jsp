...
<%
    ...
    String plMrrJs = "/resources/scripts/material/plMrr.js?rv=" + rV;
%>
...
<script src="/resources/scripts/material/plMrr.js"	></script> --%>
<script src="<%= ajaxSetupJs %>"></script>
<script src="<%= plMrrJs %>"></script>
		...
		<div class="card-body-grid" style="vertical-align: middle; ">
			<div class="table-responsive" style="vertical-align: middle; ">
							  ...
							  <colgroup>
							   ...
							   <%--  <col style="width: 5%;" />
								...
								<tr>
									...
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">MRR No.</label>
									</td>
									<td>
										<input id="txtMrrNo" type="text" class="form-control form-control-user "  autocomplete="off">
									</td>
									
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">MRR Name</label>
									</td>
									<td>
										<input id="txtMrrName" type="text" class="form-control form-control-user "  autocomplete="off">
									</td>
								</tr>
				...
				<div id="toolbar" style="margin-bottom: 1px; padding-right: 1px;">
					...
					<button id="btnMrrCreation" authType="SubS" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text">MRR Creation</span>
					</button>	
				</div>

				<div id="gridMrr" style="padding-top:1px; width:1000px; height:600px;"></div>
