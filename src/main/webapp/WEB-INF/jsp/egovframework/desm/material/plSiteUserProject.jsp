...
<%
    ...
    String plSiteUserProjectJs = "/resources/scripts/material/plSiteUserProject.js?rv=" + rV;
%>
...
<script src="/resources/scripts/material/plSiteUserProject.js"	></script> --%>
<script src="<%= ajaxSetupJs %>"></script>
<script src="<%= plSiteUserProjectJs %>"></script>
		...
		<div class="card-body-grid" style="vertical-align: middle; ">
			<div class="table-responsive" style="vertical-align: middle; ">
							...
							<table border="0" id="tblSearchBox" style="height: 43px;">
							  <colgroup>
								...
								<tr>
									...
									<td >
										<input id="txtUser" type="text" class="form-control form-control-user " autocomplete="off">
									</td>
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">ID</label>
									</td>
									<td >
										<input id="txtUserId" type="text" class="form-control form-control-user " autocomplete="off">
									</td>
									<td style="text-align: right;padding-right:10px">
				...
				<div class="container-fluid">
					...
					<div class="row row-sm">
						<div id="divUserGird" class="col-sm-6 col-xl-6 col-lg-6" style="padding-right:0; padding-left:0">
							<div id="gridDesmSiteProjectUser" style="padding-top:1px; width:100%; height:600px;"></div>
						</div>
						<div id="divProjectGird" class="col-sm-6 col-xl-6 col-lg-6" style="padding-right:0">
							<div id="gridDesmSiteProject" style="padding-top:1px; width:100%; height:600px;"></div>
						</div>
					</div>
				</div>
...
<div id="dlgIdsmProjectMgtPopUp"></div>
