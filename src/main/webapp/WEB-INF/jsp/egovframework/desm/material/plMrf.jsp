...
<%
    ...
    String plMrfJs = "/resources/scripts/material/plMrf.js?rv=" + rV;
%>
...
<script src="/resources/scripts/material/plMrf.js"	></script>
 --%>
<script src="<%= ajaxSetupJs %>"></script>
<script src="<%= plMrfJs %>"></script>
		...
		<div class="card-body-grid" style="vertical-align: middle; ">
			<div class="table-responsive" style="vertical-align: middle; ">
							...
							<table border="0" id="tblSearchBox" style="height: 43px;">
							  <colgroup>
								...
								<tr>
									...
									<td >
										<input id="txtDescription" type="text" class="form-control form-control-user " style="width: 80%;" autocomplete="off">
									</td>											
								...
								<tr>
									...
									<td>
										<input id="txtMrfNo" type="text" class="form-control form-control-user "  autocomplete="off">
									</td>
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">MRF Name</label>
									</td>
									<td>
										<input id="txtMrfName" type="text" class="form-control form-control-user "  autocomplete="off">
									</td>									
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">Subcontractor</label>
									</td>
									<td>
										<input id="txtSubconstractor" type="text" class="form-control form-control-user " autocomplete="off">
									</td>	
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">Request Date</label>
									</td>
									<td >
										<input id="txtStartRequestDate" name="inpDatePicker" type="text" class="form-control form-control-user" placeholder="" title="" style="width:100%; text-align: center; " autocomplete="off"/>										
									</td>
									<td style="text-align: center">
										<label class="" style="">~</label>
									</td>
									<td >										
										<input id="txtEndRequestDate" name="inpDatePicker" type="text" class="form-control form-control-user" placeholder="" title="" style="width:100%;text-align: center ;" autocomplete="off"/>
									</td>	
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">Material Type</label>
									</td>
									<td >
										<select id="selMaterialType" class="form-control form-control-user" style="background-color: #B4D9FD;width: 80%;" >
										</select>
									</td>																																																	
								</tr>
							</table>
				...
				<div id="toolbar" style="margin-bottom: 1px; padding-right: 1px;">
					...
					<button id="btnMrfCreation" authType="SubS" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text">MRF Creation</span>
					</button>	
				</div>

				<div id="gridMrf" style="padding-top:1px; width:1000px; height:600px;"></div>
