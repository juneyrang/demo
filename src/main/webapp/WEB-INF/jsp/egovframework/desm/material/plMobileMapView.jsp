...
<html xmlns="http://www.w3.org/1999/xhtml" lang="ko" xml:lang="ko">
	<head>
		...
		<script src="/resources/scripts/material/plMobileMapView.js"	></script>    
	...
	<body>
		<div >		
			<input id="codeType" type="hidden" value="${CODE_TYPE}"/>
			<input id="projectNo" type="hidden" value="${PROJECT_NO}"/>
			<!-- 
			<input id="trkItemName" type="hidden" value="${TRK_ITEM_NAME}"/>
			 -->
			<input id="materialCode" type="hidden" value="${MATERIAL_CODE}"/>
			<input id="packageNo" type="hidden" value="${PACKAGE_NO}"/>
