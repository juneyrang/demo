...
<%
    ...
    String plMirJs = "/resources/scripts/material/plMir.js?rv=" + rV;
%>
...
<script src="/resources/scripts/material/plMir.js"	></script> --%>
<script src="<%= ajaxSetupJs %>"></script>
<script src="<%= plMirJs %>"></script>
		...
		<div class="card-body-grid" style="vertical-align: middle; ">
			<div class="table-responsive" style="vertical-align: middle; ">
							...
							<table border="0" id="tblSearchBox" style="height: 72px;">
							  <colgroup>
								...
								<tr>
									...
									<td >
										<div style="display: inline-flex;">
											<input id="txtProjectCode" type="text" class="form-control form-control-user required" style="width:40%; text-align: center; " autocomplete="off" readonly/>
											<label style="margin: 0 1 0 1;"></label>
											<input id="txtProjectName" type="text" class="form-control form-control-user required" style="width:60%; text-align: center; "  readonly/>
										</div>
									</td>
									
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">Approval Status</label>
									</td>
									<td>
										<select id="selStatus" class="form-control form-control-user" style="background-color: #B4D9FD;">
										</select>
									</td>
									...
									<td>
										<select id="selShipmentNo" class="form-control form-control-user" style="background-color: #B4D9FD;">
									...
									<td>
										<select id="selCategory" class="form-control form-control-user" style="background-color: #B4D9FD;">
											<option value="">All</option>
								...
								<tr>
									...
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">MIR Name</label>
									</td>
									<td>
										<input id="txtMirName" type="text" class="form-control form-control-user "  autocomplete="off">
									</td>
									...
									<td>
										<input id="txtInvoiceNo" type="text" class="form-control form-control-user " autocomplete="off">
									</td>	
								...
								<tr>
									...
									<td>
										<div style="display: inline-flex;">
											<input id="txtStartReceivedDate" name="inpDatePicker" type="text" class="form-control form-control-user" placeholder="" title="" style="width:100%; text-align: center; " autocomplete="off"/>
											<label class="" style="margin: 0 3 0 3;">~</label>
											<input id="txtEndReceivedDate" name="inpDatePicker" type="text" class="form-control form-control-user" placeholder="" title="" style="width:100%;text-align: center ;" autocomplete="off"/>
										</div>							
									</td>
									...
									<td>
										<div style="display: inline-flex;">
											<input id="txtStartInspectionDate" name="inpDatePicker" type="text" class="form-control form-control-user" placeholder="" title="" style="width:100%; text-align: center; " autocomplete="off"/>
											<label class="" style="margin: 0 3 0 3;">~</label>
											<input id="txtEndInspectionDate" name="inpDatePicker" type="text" class="form-control form-control-user" placeholder="" title="" style="width:100%;text-align: center ;" autocomplete="off"/>
										</div>	
									</td>
									
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">OSDM YN</label>
									</td>
									<td>
										<select id="selOsdmYn" class="form-control form-control-user" style="background-color: #B4D9FD;">
											<option value="">All</option>
				...
				<div id="toolbar" style="margin-bottom: 1px; padding-right: 1px;">
					...
					<button id="btnMirCreation" authType="SubS" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text">MIR Creation</span>
					</button>	
				</div>

				<div id="gridMir" style="padding-top:1px; width:1000px; height:600px;"></div>
