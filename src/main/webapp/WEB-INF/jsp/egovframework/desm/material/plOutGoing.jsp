...
<%
    ...
    String plOutGoingJs = "/resources/scripts/material/plOutGoing.js?rv=" + rV;
%>
...
<script src="/resources/scripts/material/plOutGoing.js"	></script> --%>
<script src="<%= ajaxSetupJs %>"></script>
<script src="<%= plOutGoingJs %>"></script>
		...
		<div class="card-body-grid" style="vertical-align: middle; ">
			<div class="table-responsive" style="vertical-align: middle; ">
							...
							<table border="0" id="tblSearchBox" style="height: 43px;">
							  <colgroup>
								...
								<tr>
									...
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">Handover Date</label>
									</td>
									<td >
										<input id="txtStartHandoverDate" name="inpDatePicker" type="text" class="form-control form-control-user" placeholder="" title="" style="width:100%; text-align: center; " autocomplete="off"/>
									</td>
									<td style="text-align: center">
										<label class="" style="">~</label>
									</td>
									<td >
										<input id="txtEndHandoverDate" name="inpDatePicker" type="text" class="form-control form-control-user" placeholder="" title="" style="width:100%;text-align: center ;" autocomplete="off"/>
									</td>
									<td style="text-align: right;padding-right:10px">
				...
				<div id="toolbar" style="margin-bottom: 1px; padding-right: 1px;">
					...
					<button id="btnOutGoingReport" authType="R" class="btn btn-success btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-file"></i></span>
						<span class="text">Report</span>
					</button>
					<button id="btnOutGoingDelete" authType="S" class="btn btn-danger btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-trash"></i></span>
						<span class="text">Delete</span>
					</button>
					<button id="btnOutGoingCreation" authType="S" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text">Creation</span>
					</button>
				</div>

				<div id="gridOutGoing" style="padding-top:1px; width:1000px; height:600px;"></div>
