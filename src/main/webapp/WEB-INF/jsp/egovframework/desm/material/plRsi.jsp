...
<%
    ...
    String plRsiJs = "/resources/scripts/material/plRsi.js?rv=" + rV;
%>
...
<script src="/resources/scripts/material/plRsi.js"	></script> --%>
<script src="<%= ajaxSetupJs %>"></script>
<script src="<%= plRsiJs %>"></script>
		...
		<div class="card-body-grid" style="vertical-align: middle; ">
			<div class="table-responsive" style="vertical-align: middle; ">
							...
							<table border="0" id="tblSearchBox" style="height: 43px;">
							  <colgroup>
								...
								<tr>
									...
									<td>
										<input id="txtRsiNo" type="text" class="form-control form-control-user "  autocomplete="off">
									</td>
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">RSI Name</label>
									</td>
									<td>
										<input id="txtRsiName" type="text" class="form-control form-control-user "  autocomplete="off">
									</td>									
									<td style="text-align: right;padding-right:10px">
				...
				<div id="toolbar" style="margin-bottom: 1px; padding-right: 1px;">
					...
					<button id="btnRsiCreation" authType="SubS" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text">RSI Creation</span>
					</button>	
				</div>

				<div id="gridRsi" style="padding-top:1px; width:1000px; height:600px;"></div>
