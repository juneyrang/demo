...
<%
    ...
    String plManageJs = "/resources/scripts/material/plManage.js?rv=" + rV;
%>
...
<script src="/resources/scripts/material/plManage.js"	></script> --%>
<script src="<%= ajaxSetupJs %>"></script>
<script src="<%= plManageJs %>"></script>
		...
		<div class="card-body-grid" style="vertical-align: middle; ">
			<div class="table-responsive" style="vertical-align: middle; ">
							...
							<table border="0" id="tblSearchBox" style="height: 43px;">
							  <colgroup>
								...
								<tr>
									...
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">RSI Confirm​</label>
									</td>
									<td>
										<select id="selRsiConfirm" class="form-control form-control-user" style="background-color: #B4D9FD;">
											<option value="">All</option>
								...
								<tr>
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">Location Update</label>
									</td>
									<td >
										<input id="txtStartLocationUpdate" name="inpDatePicker" type="text" class="form-control form-control-user" placeholder="" title="" style="width:100%; text-align: center; " autocomplete="off"/>
									</td>
									<td style="text-align: center">
										<label class="" style="">~</label>
									</td>
									<td >
										<input id="txtEndLocationUpdate" name="inpDatePicker" type="text" class="form-control form-control-user" placeholder="" title="" style="width:100%;text-align: center ;" autocomplete="off"/>
									</td>
									<td style="text-align: right;padding-right:10px">
				...
				<div id="toolbar" style="margin-bottom: 1px; padding-right: 1px;height:0px">
					...
					<button id="btnMaterialManageDelete" authType="S" class="btn btn-danger btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-trash"></i></span>
						<span class="text">Delete</span>
					</button>
					<button id="btnMaterialManageCreation" authType="S" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text">Creation</span>
					</button>
					<button id="btnMaterialManageBatchExpiredDate" authType="S" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text">Expired Date Update</span>
					</button>
					<button id="btnMaterialManageBatchCategory" authType="S" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text">Category Update</span>
					</button>
					<button id="btnMaterialManageBatchType" authType="S" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text">Type Update</span>
					</button>
					<button id="btnMaterialManageBatchRsiConfirm" authType="S" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text">RSI Confirm Update</span>
					</button>
				</div>

				<div id="gridIdsmOsManage" style="padding-top:1px; width:1000px; height:600px;"></div>

			</div>
		</div>
	</div>
</div>
<div id="dlgMaterialManagePopUp"></div>
