...
<%
    ...
    String plRsiViewJs = "/resources/scripts/material/plRsiView.js?rv=" + rV;
%>
...
<script src="/resources/scripts/material/plRsiView.js"	></script> --%>
<script src="<%= ajaxSetupJs %>"></script>
<script src="<%= plRsiViewJs %>"></script>
	...
	<div class="card shadow mb-4">
		<div class="card-body-grid" style="vertical-align: middle; ">
			<div class="table-responsive" style="vertical-align: middle; ">
							...
							<table border="0" id="tblSearchBox" style="height: 43px;">
							  <colgroup>
								...
								<tr>
									...
									<td>
										<input id="txtSubconstractor" type="text" class="form-control form-control-user " style="width: 80%;"  autocomplete="off">
									</td>
								...
								<tr>
									...
									<td>
										<select id="selQty" class="form-control form-control-user" style="background-color: #B4D9FD;width: 80%;">
											<option value="">All</option>
				...
				<div id="gridRsiView" style="padding-top:1px; width:1000px; height:600px;"></div>
