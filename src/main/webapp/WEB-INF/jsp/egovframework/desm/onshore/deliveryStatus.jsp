...
<%
    ...
    String plDeliveryJs = "/resources/scripts/onshore/deliveryStatus.js?rv=" + rV;
%>
...
<script src="/resources/scripts/onshore/deliveryStatus.js"	></script> --%>
<script src="<%= ajaxSetupJs %>"></script>
<script src="<%= plDeliveryJs %>"></script>
		...
		<div class="card-body-grid" style="vertical-align: middle; ">
			<div class="table-responsive" style="vertical-align: middle; ">
						...
						<td width="100%">
							<table border="0" id="tblSearchBox" style="height: 43px;">
							  <colgroup>
								...
								<tr>
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">Plan Date</label>
									</td>
									<td>
										<input id="txtFromPlanDate" name="inpDatePicker" type="text" class="form-control form-control-user" placeholder="" title="" style="width:100%; text-align: center; " autocomplete="off"/>
									</td>
									<td>
										<label class="" style="margin: 0 3 0 3;">~</label>
									</td>
									<td>
										<input id="txtToPlanDate" name="inpDatePicker" type="text" class="form-control form-control-user" placeholder="" title="" style="width:100%;text-align: center ;" autocomplete="off"/>
									</td>
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">Order No.</label>
									</td>
									<td>
										<input id="txtOrderNo" type="text" class="form-control form-control-user " autocomplete="off">
									</td>
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">Order Name</label>
									</td>
									<td>
										<input id="txtOrderName" type="text" class="form-control form-control-user " autocomplete="off">
									</td>
									<td style="text-align: right;padding-right:10px">
				...
				<div id="toolbar" style="margin-bottom: 1px; padding-right: 1px;">
					...
					<button id="btnDeliveryDelete" authType="S" class="btn btn-danger btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-trash"></i></span>
						<span class="text">Delete</span>
					</button>
					<button id="btnDeliveryCreation" authType="S" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text">Creation</span>
					</button>
				</div>

				<div id="gridDelivery" style="padding-top:1px; width:1000px; height:600px;"></div>
