...
<%
    ...
    String plPaymentJs = "/resources/scripts/onshore/paymentStatus​.js?rv=" + rV;
%>
...
<script src="/resources/scripts/onshore/paymentStatus.js"	></script> --%>
<script src="<%= ajaxSetupJs %>"></script>
<script src="<%= plPaymentJs %>"></script>
		...
		<div class="card-body-grid" style="vertical-align: middle; ">
			<div class="table-responsive" style="vertical-align: middle; ">
				...
				<div id="toolbar" style="margin-bottom: 1px; padding-right: 1px;">
					...
					<button id="btnPaymentSave" authType="R" class="btn btn-success btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-file"></i></span>
						<span class="text">Save</span>
					</button>
					<button id="btnPaymentDelete" authType="S" class="btn btn-danger btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-trash"></i></span>
						<span class="text">Delete</span>
					</button>
					<button id="btnPaymentCreation" authType="S" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text">Creation</span>
					</button>
				</div>

				<div id="gridPayment" style="padding-top:1px; width:1000px; height:600px;"></div>
