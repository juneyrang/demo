...
<%
    ...
    String plContractJs = "/resources/scripts/onshore/contractList.js?rv=" + rV;
%>
...
<script src="/resources/scripts/material/plContract.js"	></script> --%>
<script src="<%= ajaxSetupJs %>"></script>
<script src="<%= plContractJs %>"></script>
		...
		<div class="card-body-grid" style="vertical-align: middle; ">
			<div class="table-responsive" style="vertical-align: middle; ">
							...
							<table border="0" id="tblSearchBox" style="height: 43px;">
							  <colgroup>
								...
								<tr>
									...
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">Contract No.</label>
									</td>
									<td>
										<input id="txtContractNo" type="text" class="form-control form-control-user " autocomplete="off">
									</td>
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">Contract Name</label>
									</td>
									<td>
										<input id="txtContractName" type="text" class="form-control form-control-user " autocomplete="off">
									</td>
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">Contractor</label>
									</td>
									<td>
										<input id="txtContractor" type="text" class="form-control form-control-user " autocomplete="off">
									</td>
								</tr>
								<tr>
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">Term</label>
									</td>
									<td>
										<input id="txtFromTermDate" name="inpDatePicker" type="text" class="form-control form-control-user" placeholder="" title="" style="width:100%; text-align: center; " autocomplete="off"/>
									</td>
									<td>
										<label class="" style="margin: 0 3 0 3;">~</label>
									</td>
									<td>
										<input id="txtToTermDate" name="inpDatePicker" type="text" class="form-control form-control-user" placeholder="" title="" style="width:100%;text-align: center ;" autocomplete="off"/>
									</td>
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">Contract Date</label>
									</td>
									<td>
										<input id="txtContractDate" name="inpDatePicker" type="text" class="form-control form-control-user" placeholder="" title="" style="width:100%; text-align: center; " autocomplete="off"/>
									</td>
									<td style="text-align: right;padding-right:10px">
									...
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">Closed</label>
									</td>
									<td>
										<select id="selClosed" class="form-control form-control-user" style="background-color: #B4D9FD;">
											<option value="">All</option>
				...
				<div id="toolbar" style="margin-bottom: 1px; padding-right: 1px;">
					...
					<!-- <button id="btnContractSave" authType="R" class="btn btn-success btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-file"></i></span>
						<span class="text">Save</span>
					</button> -->
					<button id="btnContractDelete" authType="S" class="btn btn-danger btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-trash"></i></span>
						<span class="text">Delete</span>
					</button>
					<button id="btnContractCreation" authType="S" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text">Creation</span>
					</button>
				</div>

				<div id="gridContract" style="padding-top:1px; width:1000px; height:600px;"></div>
