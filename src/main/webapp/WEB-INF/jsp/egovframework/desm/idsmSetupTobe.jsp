...
<%
    ...
    String idsmSetupTobeJs = "/resources/scripts/idsmSetupTobe.js?rv=" + rV;
%>
...
<script src="/resources/scripts/idsmSetupTobe.js"	></script> --%>
<script src="<%= ajaxSetupJs %>"></script>
<script src="<%= idsmSetupTobeJs %>"></script>
		...
		<div class="card-body-grid" style="vertical-align: middle; ">
			<div class="table-responsive" style="vertical-align: middle; ">
				...
				<div id="toolbar" style="margin-bottom: 1px; padding-right: 1px;">
					...
					<!-- 230620 통합VTS 1차 오픈은 해당 기능 제외 후 배포 
					...
					230620 통합VTS 1차 오픈은 해당 기능 제외 후 배포 끝
					-->
					<!--
					...
					<button id="btnItemCopy" authType="S" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-clone"></i></span>
						<span class="text"><spring:message code='button.desm.copy.item'/></span>
					</button>

					<button id="btnLowItemCopy" authType="S"  class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-clone"></i></span>
						<span class="text"><spring:message code='button.desm.child.copy.item'/></span>
					</button>
...
<div class="modal hide fade" id="dlgInvEdit" tabindex="-1" role="dialog" aria-labelledby="dlgInvEditTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false" style="z-index:1100">
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="max-width: 600px;">
		<div class="modal-content">
			<div class="modal-header">
				<h6 class="modal-title" id="dlgInvEditTitle"><spring:message code="modal.inv.edit.title" /></h6>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
...
<div class="modal hide fade" id="dlgAdminAddList" tabindex="-1" role="dialog" aria-labelledby="dlgAdminAddListTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false" style="z-index:1100">
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="max-width: 600px;">
		<div class="modal-content">
			<div class="modal-header">
				<h6 class="modal-title" id="dlgAdminAddListTitle"><spring:message code='modal.admin.add.list.title'	/></h6>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
				...
				<div class="p-2 pl-4 pr-4">
					<div class="form-group row mb-1">
						<div class="col-sm-3 text-right font-weight-bold" >
							<label class="required" style="line-height: 2;"><spring:message code='grid.col.person'	/></label>
						</div>
						<div class="col-sm-3">
...
<!-- 						<div class="col-sm-7 col-xl-7 col-lg-7" > -->
							...
							<div class="card shadow mb-2">
								<div class="card-header py-1" style="padding-top:2px; padding-bottom:2px">
									<h7 class="m-0 font-weight-bold text-primary" ><spring:message code='modal.create.item.item.info.label'	/></h7>
								</div>
								<div class="card-body" style="padding: 1px">
									...
									<div class="form-group row mb-1">
										<div style="padding-left:0" class="col-sm-3 text-right font-weight-bold">
											<label style="line-height : 2"><spring:message code='modal.create.item.item.info.item.b.label'	/></label>
										</div>
										<div style="padding-left:0" class="col-sm-3 search_in">
									...
									<div class="form-group row mb-1">
										<div style="padding-left:0" class="col-sm-3 text-right font-weight-bold">
											<label style="line-height : 2"><spring:message code='modal.create.item.item.info.shipping.order'	/></label>
										</div>
										<div style="padding-left:0" class="col-sm-3">
										...
										<div style="padding-left:0" class="col-sm-3 text-right font-weight-bold">
											<!--
											<label style="line-height : 2">Sequence</label>
											 -->
										</div>
										<div style="padding-left:0" class="col-sm-3">
											<!--
											<input id="txtdlgCreateItemSequence" type="text" class="form-control form-control-user " >
											 -->
										</div>
									</div>
									<div class="form-group row mb-1">
							...
							<div class="card shadow mb-2">
								<div class="card-header py-1" style="padding-top:2px; padding-bottom:2px">
									...
									<button id="btnCreateItemDelete" class="btn btn-danger btn-icon-split btn-sm" role="button" style="float: right; height: 25px">
										<span class="icon text-white-50"><i class="fas fa-trash"></i></span>
										<span class="text" style="font-size:0.8em"><spring:message code='button.desm.del'	/></span>
									</button>
									<button id="btnCreateItemAdd" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float: right; margin-right : 4px; height: 25px">
										<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
										<span class="text" style="font-size:0.8em"><spring:message code='button.desm.add'	/></span>
									</button>
								</div>
								<div class="card-body" style="padding: 1px">
...
<!-- 						<div class="col-sm-5 col-xl-5 col-lg-5" style="padding-left:0;"> -->
							...
							<div class="card shadow mb-2">
								<div class="card-header py-1" style="padding-top:2px; padding-bottom:2px">
									<h7 class="m-0 font-weight-bold text-primary"><spring:message code="modal.create.item.shcedule.info.label" /></h7>
								</div>
								<div class="card-body" style="padding: 1px">
									<div class="form-group row mb-1">
										<div class="col-sm-2 text-left font-weight-bold label-max-min-width">
											<label class="text-info" style="line-height: 2; padding-left: 0.8rem;"><spring:message code="grid.col.mps" /></label>
										</div>
										<div style="padding-left:0" class="col-sm-2 text-right font-weight-bold">
											<label style="line-height : 2"><spring:message code="grid.col.plan.l3" /></label>
										</div>
									...
									<div class="form-group row mb-1">
										...
										<div style="padding-left:0" class="col-sm-2 text-right font-weight-bold">
											<label style="line-height : 2"><spring:message code="grid.col.expected" /></label>
										</div>
										<div style="padding-left:0" class="col-sm-3 text-max-min-width">
									...
									<div class="form-group row mb-1">
										...
										<div style="padding-left:0" class="col-sm-2 text-right font-weight-bold">
											<label style="line-height : 2"><spring:message code="grid.col.actual" /></label>
										</div>
										<div style="padding-left:0" class="col-sm-3 text-max-min-width">
									...
									<div class="form-group row mb-1">
										<div class="col-sm-2 text-left font-weight-bold label-max-min-width">
											<label class="text-info" style="line-height: 2; padding-left: 0.8rem;"><spring:message code="grid.col.te" /></label>
										</div>
										<div style="padding-left:0" class="col-sm-2 text-right font-weight-bold">
											<label style="line-height : 2"><spring:message code="grid.col.plan" /></label>
										</div>
										<div style="padding-left:0" class="col-sm-3 text-max-min-width">
											<input id="txtdlgCreateItemTePlanDate" name="inpDatePicker" type="text" class="form-control form-control-user " autocomplete="off">
										</div>
									</div>
									<div class="form-group row mb-1">
										<div class="col-sm-2 text-left font-weight-bold label-max-min-width">
										...
										<div style="padding-left:0" class="col-sm-3 text-max-min-width">
											<input id="txtdlgCreateItemTeExpectedDate" name="inpDatePicker" type="text" class="form-control form-control-user " autocomplete="off">
										</div>
									</div>
									<div class="form-group row mb-1">
										<div class="col-sm-2 text-left font-weight-bold label-max-min-width">
										...
										<div style="padding-left:0" class="col-sm-3 text-max-min-width">
											<input id="txtdlgCreateItemTeActualDate" name="inpDatePicker" type="text" class="form-control form-control-user " autocomplete="off">
										</div>
									</div>
									<hr class="m-1" />
									<div class="form-group row mb-1">
										<div class="col-sm-2 text-left font-weight-bold label-max-min-width">
											<label class="text-info" style="line-height: 2; padding-left: 0.8rem; width: 85"><spring:message code="grid.col.purchase.duration" /></label>
										</div>
									...
									<div class="form-group row mb-1">
										<div class="col-sm-2 text-left font-weight-bold label-max-min-width">
											<label class="text-info" style="line-height: 2; padding-left: 0.8rem;"><spring:message code="grid.col.make.duration" /></label>
										</div>
									...
									<div class="form-group row mb-1">
										<div class="col-sm-2 text-left font-weight-bold label-max-min-width">
											<label class="text-info" style="line-height: 2; padding-left: 0.8rem;"><spring:message code="grid.col.cargo.ready" /></label>
										</div>
										<div style="padding-left:0" class="col-sm-2 text-right font-weight-bold">
											<label style="line-height : 2"><spring:message code="grid.col.plan" /></label>
										</div>
									...
									<div class="form-group row mb-1">
										<div class="col-sm-2 text-left font-weight-bold label-max-min-width">
											<label class="text-info" style="line-height: 2; padding-left: 0.8rem;"><spring:message code="grid.col.shipment.duration" /></label>
										</div>
										<div style="padding-left:0" class="col-sm-2">
											<label style="line-height : 2"></label>
										</div>
									...
									<div class="form-group row mb-1">
										<div class="col-sm-2 text-left font-weight-bold label-max-min-width">
											<label class="text-info" style="line-height: 2; padding-left: 0.8rem; width: 79"><spring:message code="grid.col.fob" /></label>
										</div>
										<div style="padding-left:0" class="col-sm-2 text-right font-weight-bold">
											<label style="line-height : 2"><spring:message code="grid.col.plan.l3" /></label>
										</div>
									...
									<div class="form-group row mb-1">
										<div class="col-sm-2 text-left font-weight-bold label-max-min-width">
											<label class="text-info" style="line-height: 2; padding-left: 0.8rem;"><spring:message code="grid.col.trans.duration" /></label>
										</div>
										<div style="padding-left:0" class="col-sm-2">
											<label style="line-height : 2"></label>
										</div>
									...
									<div class="form-group row mb-1">
										<div class="col-sm-2 text-left font-weight-bold label-max-min-width">
											<label class="text-info" style="line-height: 2; padding-left: 0.8rem;"><spring:message code="grid.col.on.site" /></label>
										</div>
										<div style="padding-left:0" class="col-sm-2 text-right font-weight-bold">
											<label style="line-height : 2"><spring:message code="grid.col.plan.l3" /></label>
										</div>
...
<div class="modal hide fade" id="dlgItemSchedule" tabindex="-1" role="dialog" aria-labelledby="dlgItemScheduleTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 1100px;">
		<div class="modal-content">
			<div class="modal-header">
				<h6 class="modal-title" id="dlgItemScheduleTitle"><spring:message code='modal.item.schedule.title'/></h6>
			...
			<div class="modal-body" style="padding: 5px">
				<div class="container-fluid" style="padding: 0px;">
					<div class="row row-sm">
						<div class="col-sm-12 col-xl-12 col-lg-12" style="padding-left:0;">

							<div style="float:left;margin-top: 5px;margin-left: 20px;color: #4e73df;font-weight: bold;">
								<span id="gridItemScheduleItemRootName"></span>
							</div>
							<div style="float:right;text-align: right;">
								<button id="btnDlgItemScheduleEdit" authType="S" class="btn btn-primary btn-icon-split btn-sm" data-dismiss="modal">
									<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
									<span class="text"><spring:message code='button.desm.save'/></span>
								</button>
								<button class="btn btn-secondary btn-icon-split btn-sm" data-dismiss="modal">
									<span class="icon text-white-50"><i class="fas fa-window-close"></i></span>
									<span class="text"><spring:message code="button.close" /></span>
...
<!-- 							</div> -->
							...
							<div class="card shadow mb-2">
								<div class="card-header py-1" style="padding-top:2px; padding-bottom:2px">
									<label class="font-weight-bold text-primary"><spring:message code='modal.create.item.item.info.label'/></label>
								</div>
								<div class="card-body" style="padding: 1px">
									<div class="form-group row mb-1">
										<div class="col-sm-3 text-right font-weight-bold">
											<label class="" style="line-height : 2"><spring:message code='modal.create.item.item.info.item.b.label'/></label>
										</div>
									...
									<div class="form-group row mb-1">
										<div class="col-sm-3 text-right font-weight-bold">
											<label class="" style="line-height : 2"><spring:message code='modal.create.item.item.info.shipping.order'/></label>
										</div>
									...
									<div class="form-group row mb-1">
										<div class="col-sm-3 text-right font-weight-bold">
											<label class="" style="line-height : 2">Sequence</label>
										</div>
										<div class="col-sm-8" style="padding-right : 0">
											<input id="txtDlgItemScheduleAttribute9" type="text" class="form-control form-control-user " autocomplete="off" readonly>
										</div>
										<div class="col-sm-1" >
										</div>
									</div>
									<div class="form-group row mb-1">
										<div class="col-sm-3 text-right font-weight-bold">
											<label class="" style="line-height : 2">Vendor</label>
										</div>
										<div class="col-sm-8" style="padding-right : 0">
											<input id="txtDlgItemScheduleAttribute3" type="text" class="form-control form-control-user " autocomplete="off">
										</div>
										<div class="col-sm-1" >
										</div>
									</div>
									<div class="form-group row mb-1">
										<div class="col-sm-3 text-right font-weight-bold">
											<label class="" style="line-height : 2"><spring:message code='grid.col.shipping.country'/></label>
										</div>
										<div class="col-sm-8" style="padding-right : 0">
									...
									<div class="form-group row mb-1">
										<div class="col-sm-3 text-right font-weight-bold">
											<label class="" style="line-height : 2"><spring:message code='grid.col.l3.id'/></label>
										</div>
										<div class="col-sm-8" style="padding-right : 0">
									...
									<div class="form-group row mb-1">
										<div class="col-sm-3 text-right font-weight-bold">
											<label class="" style="line-height : 2"><spring:message code='grid.col.payment.milestone'/></label>
										</div>
										<div class="col-sm-8" style="padding-right : 0">
									...
									<div class="form-group row mb-1">
										<div class="col-sm-3 text-right font-weight-bold">
											<label class="" style="line-height : 2"><spring:message code='grid.col.on.off.shore'/></label>
										</div>
										<div class="col-sm-8" style="padding-right : 0">
									...
									<div class="form-group row mb-1">
										...
										<div class="col-sm-1" >
											<button id="btnDlgItemScheduleSelInvoiceNumEdit" authType="S" class="btn btn-primary btn-icon-split" role="button" style="width:21px;height:21px">
							...
							<div class="card shadow mb-2">
								<div class="card-header py-1" style="padding-top:2px; padding-bottom:2px; padding-bottom: 0rem !important; padding-top: 0rem !important; vertical-align: middle;">
									...
									<button id="btnDlgItemScheduleAdminDelete" authType="S"  class="btn btn-danger btn-icon-split btn-sm" role="button" style="float: right; height: 20px;">
										<span class="icon text-white-50" style="padding: 0.1rem 0.5rem;"><i class="fas fa-trash" ></i></span>
										<span class="text" style="padding: 0.1rem 0.5rem; font-size:0.8em"><spring:message code='button.desm.del'/></span>
									</button>
									<button id="btnDlgItemScheduleAdminAdd" authType="S"  class="btn btn-primary btn-icon-split btn-sm" role="button" style="float: right; margin-right : 4px; height: 20px">
										<span class="icon text-white-50" style="padding: 0.1rem 0.5rem;"><i class="fas fa-pencil-alt"></i></span>
										<span class="text" style="padding: 0.1rem 0.5rem; font-size:0.8em"><spring:message code='button.desm.add'/></span>
									</button>
								</div>
								<div class="card-body" style="padding: 1px">
									<div class="table-responsive">
										<div id="gridItemScheduleAdmin" style="padding-top:4px;height:175px;"></div>
									</div>
								</div>
							</div>
						</div>
...
<!-- 							</div> -->
							...
							<div class="card-body tab-content" style="padding:2px 0 0 0;">
								...
								<div class="tab-pane active show" id="tabCont1">
									...
									<div class="card shadow mb-2">
										<div class="card-header py-1" style="padding-top:2px; padding-bottom:2px">
											<label class="font-weight-bold text-primary"><spring:message code="modal.item.schedule.info.label" /></label>
										</div>
										<div class="card-body" style="padding: 1px">
											<div class="form-group row mb-1">
												<div class="col-sm-2 text-left font-weight-bold label-max-min-width">
												...
												<div class="col-sm-2 text-right font-weight-bold">
													<label class="" style="line-height : 2"><spring:message code="grid.col.plan.l3" /></label>
												</div>
											...
											<div class="form-group row mb-1">
												...
												<div class="col-sm-2 text-right font-weight-bold">
													<label class="" style="line-height : 2"><spring:message code="grid.col.expected" /></label>
												</div>
												<div class="col-sm-3 text-max-min-width">
											...
											<div class="form-group row mb-1">
												...
												<div class="col-sm-2 text-right font-weight-bold" style="height: 20px;">
													<label class="" style="line-height : 2"><spring:message code="grid.col.actual" /></label>
												</div>
											...
											<div class="form-group row mb-1">
												...
												<div class="col-sm-2 text-right font-weight-bold">
													<label class="" style="line-height : 2"><spring:message code="grid.col.plan" /></label>
												</div>
												<div class="col-sm-3 text-max-min-width">
													<input id="txtDlgItemScheduleTePlanDate" name="inpDatePicker" type="text" class="form-control form-control-user " autocomplete="off">
												</div>
											</div>
											<div class="form-group row mb-1">
												<div class="col-sm-2 text-left font-weight-bold label-max-min-width">
												...
												<div class="col-sm-3 text-max-min-width">
													<input id="txtDlgItemScheduleTeExpectedDate" name="inpDatePicker" type="text" class="form-control form-control-user " autocomplete="off">
												</div>
											</div>
											<div class="form-group row mb-1">
												<div class="col-sm-2 text-left font-weight-bold label-max-min-width" style="height: 20px;">
												...
												<div class="col-sm-3 text-max-min-width" style="height: 20px;">
													<input id="txtDlgItemScheduleTeActualDate" name="inpDatePicker" type="text" class="form-control form-control-user " autocomplete="off">
												</div>
											</div>
											<hr class="m-1" />
											<div class="form-group row mb-1">
												<div class="col-sm-2 text-left font-weight-bold label-max-min-width" style="height: 20px;">
													<label class="text-info" style="line-height: 2; padding-left: 0.8rem;"><spring:message code="grid.col.purchase.duration" /></label>
												</div>
												<div class="col-sm-2 text-right font-weight-bold" style="height: 20px;">
													<label class=""></label>
												</div>
											...
											<div class="form-group row mb-1">
												<div class="col-sm-2 text-left font-weight-bold label-max-min-width">
													<label class="text-info" style="line-height: 2; padding-left: 0.8rem;"><spring:message code="grid.col.po" /></label>
												</div>
												<div class="col-sm-2 text-right font-weight-bold">
													<label class="" style="line-height : 2"><spring:message code="grid.col.plan.l3" /></label>
												</div>
											...
											<div class="form-group row mb-1">
												...
												<div class="col-sm-3 text-max-min-width">
													<input id="txtDlgItemScheduleCargoPlanDate" name="inpDatePicker" type="text" class="form-control form-control-user ">
												</div>
											</div>
											<div class="form-group row mb-1">
												<div class="col-sm-2 text-left font-weight-bold label-max-min-width">
...
<div class="modal hide fade" id="dlgMemo" tabindex="-1" role="dialog" aria-labelledby="dlgMemoTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false" style="z-index:1100">
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="max-width: 600px;">
		<div class="modal-content">
			<div class="modal-header">
				<h6 class="modal-title" id="dlgMemoTitle">Memo</h6>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			...
			<div class="modal-body">
				<textarea id="txtdlgMemoRemark" class="form-control form-control-user " cols="80" rows="15" style = "font-size:11px;line-height:1.5;padding:5px"></textarea>
			</div>

			<div class="modal-footer">

				<button id="btnDlgMemoSave" authType="S"  class="btn btn-success btn-icon-split btn-sm">
					<span class="icon text-white-50"><i class="fas fa-save"></i></span>
					<span class="text"><spring:message code="button.save" /></span>
				</button>
				<button class="btn btn-secondary btn-icon-split btn-sm" data-dismiss="modal">
...
<%-- TASK_NUMBER 조회 팝업 --%>
<div class="modal hide fade" id="dlgTaskNumber" tabindex="-1" role="dialog" aria-labelledby="dlgTaskNumberTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false" style="z-index:1100">
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="max-width: 800px;">
		<div class="modal-content">
			<div class="modal-header">
				<h6 class="modal-title" id="dlgTaskNumberTitle">ERP Activity Mapping</h6>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			...
			<div class="modal-body">
				<div class="p-2 pl-4 pr-4">
						...
						<table border="0" style="width: 100%;">
							<tr>
								...
								<td style="width: 290px;">
									<input id="txtDlgTask" type="text" class="form-control form-control-user required" autocomplete="off" />
									<i id="iconDlgTask" class="fas fa-search" style="float : right;margin:-18px 2px 0 0;cursor : pointer; color : #8CACB2;font-size:0.9rem;"></i>
								</td>
							</tr>
						</table>
					</div>
					<div class="form-group row mb-1">
						<div class="table-responsive" style = "padding-top: 5px;">
							<div id="gridDlgTask" style="padding-top:1px"></div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="modal-footer">
				<button id="btnDlgTaskReset"  class="btn btn-danger btn-icon-split btn-sm">
					<span class="icon text-white-50"><i class="fas fa-save"></i></span>
					<span class="text"><spring:message code="button.desm.reset" /></span>
				</button>
				<button id="btnDlgTaskSelect"  class="btn btn-success btn-icon-split btn-sm">
					<span class="icon text-white-50"><i class="fas fa-save"></i></span>
					<span class="text"><spring:message code="button.desm.select" /></span>
				</button>
				<button class="btn btn-secondary btn-icon-split btn-sm" data-dismiss="modal">
...
<%-- PR No 조회 팝업 --%>
<div class="modal hide fade" id="dlgPrNo" tabindex="-1" role="dialog" aria-labelledby="dlgPrNoTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false" style="z-index:1100">
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="max-width: 1200px;">
		<div class="modal-content">
			<div class="modal-header">
				<h6 class="modal-title" id="dlgPrNoTitle">PR No Mapping</h6>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
				...
				<div class="p-2 pl-4 pr-4">
					<div class="form-group row mb-1">
						<table border="0" style="width: 100%;">
							<tr>
								<td style="width: 30px;">
									<label class="" style="">Activity</label>
								</td>
								<td style="width: 200px; padding-right: 20px;">
									<input id="txtDlgPrNoTask" type="text" class="form-control form-control-user required" autocomplete="off" />
								</td>
								<td style="width: 30px;">
									<label class="" style="">PR</label>
								</td>
								<td style="width: 200px; padding-right: 20px;">
									<input id="txtDlgPrNo" type="text" class="form-control form-control-user required" autocomplete="off" />
								</td>
								<td style="width: 30px;">
									<label class="" style="">Item</label>
								</td>
								<td style="width: 200px; padding-right: 20px;">
									<input id="txtDlgPrNoItem" type="text" class="form-control form-control-user required" autocomplete="off" />
								</td>
								<td style="width: 10px;">
									<button id="btnDlgPrNoSearch" class="btn btn-primary btn-icon-split" role="button" style="width:80px; background-color:#4599EE !important; margin-top: 0.5px;height: 22px;"> <%--authType="R"  --%>
										<span class="icon" style="padding:0.19rem 0.3rem 0.375rem 0.75rem; background:0">
											<i class="fas fa-search"></i>
										</span>
										<span class="text" style="padding:0.19rem 0.75rem 0.375rem 0rem;">Search</span>
					...
					<div class="form-group row mb-1">
						<div class="table-responsive" style = "padding-top: 5px;">
							<div id="gridDlgPrNo" style="padding-top:1px"></div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="modal-footer">
				<button id="btnDlgPrNoReset"  class="btn btn-danger btn-icon-split btn-sm">
					<span class="icon text-white-50"><i class="fas fa-save"></i></span>
					<span class="text"><spring:message code="button.desm.reset" /></span>
				</button>
				<button id="btnDlgPrNoSelect"  class="btn btn-success btn-icon-split btn-sm">
					<span class="icon text-white-50"><i class="fas fa-save"></i></span>
					<span class="text"><spring:message code="button.desm.select" /></span>
				</button>
				<button class="btn btn-secondary btn-icon-split btn-sm" data-dismiss="modal">
...
<%-- MPR 조회 팝업 --%>
<div class="modal hide fade" id="dlgMpr" tabindex="-1" role="dialog" aria-labelledby="dlgMprTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false" style="z-index:1100">
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="max-width: 1200px;">
		<div class="modal-content">
			<div class="modal-header">
				<h6 class="modal-title" id="dlgMprTitle">MPR Mapping</h6>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			...
			<div class="modal-body">
				<div class="p-2 pl-4 pr-4">
					<div class="form-group row mb-1">
						<table border="0" style="width: 100%;">
							<tr>
								...
								<td style="width: 200px; padding-right: 20px;">
									<input id="txtDlgMprPoNo" type="text" class="form-control form-control-user required" autocomplete="off" />
								</td>
								<td style="width: 30px;">
									<label class="" style="">MPR No</label>
								</td>
								<td style="width: 200px; padding-right: 20px;">
									<input id="txtDlgMprNo" type="text" class="form-control form-control-user required" autocomplete="off" />
								</td>
								<td style="width: 30px;">
									<label class="" style="">Supplier</label>
								</td>
								<td style="width: 200px; padding-right: 20px;">
									<input id="txtDlgMprSupplier" type="text" class="form-control form-control-user required" autocomplete="off" />
								</td>
								<td style="width: 10px;">
									<button id="btnDlgMprSearch" class="btn btn-primary btn-icon-split" role="button" style="width:80px; background-color:#4599EE !important; margin-top: 0.5px;height: 22px;"> <%--authType="R"  --%>
										<span class="icon" style="padding:0.19rem 0.3rem 0.375rem 0.75rem; background:0">
											<i class="fas fa-search"></i>
										</span>
										<span class="text" style="padding:0.19rem 0.75rem 0.375rem 0rem;">Search</span>
					...
					<div class="form-group row mb-1">
						<div class="table-responsive" style = "padding-top: 5px;">
							<div id="gridDlgMpr" style="padding-top:1px"></div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="modal-footer">
				<%--TODO: 초기화 눌러서 필드 비우는 기능 추가 --%>
				<button id="btnDlgMprSelect"  class="btn btn-success btn-icon-split btn-sm">
					<span class="icon text-white-50"><i class="fas fa-save"></i></span>
					<span class="text"><spring:message code="button.desm.select" /></span>
				</button>
				<button class="btn btn-secondary btn-icon-split btn-sm" data-dismiss="modal">
