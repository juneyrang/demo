...
<%
    ...
    String blrSchmapJs = "/resources/scripts/blrSchmap.js?rv=" + rV;
%>
...
<script src="/resources/scripts/blrSchmap.js"	></script> --%>
<script src="<%= ajaxSetupJs %>"></script>
<script src="<%= blrSchmapJs %>"></script>
	...
	<div class="card shadow mb-4">
		<div class="card-body-grid" style="vertical-align: middle; ">
			<div class="table-responsive" style="vertical-align: middle; ">
							...
							<table border="0" id="tblSearchBox" style="height: 43px;">
							  <colgroup>
								...
								<tr>
									...
									<td style="text-align: right;padding-right:10px">
										<label class="" style=""> Activity명</label>
									</td>
									<td colspan = "2">
										<input id="txtaActivityName" type="text" class="form-control form-control-user " autocomplete="off">
									</td>
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">품목</label>
									</td>
									<td colspan = "2">
										<input id="txtItemName" type="text" class="form-control form-control-user " autocomplete="off">
									</td>									
								</tr>
								<tr>
									<td style="text-align: right;padding-right:10px">
									...
									<td colspan = "2">
										<input id="txtTaskNumber" type="text" class="form-control form-control-user " autocomplete="off">
									</td>
									<td style="text-align: right;padding-right:10px">
										<label class="" style="">미 입력 Task</label>
									</td>									
									<td colspan = "5">
										<input id="chkNotMapFlag" type="checkbox" class="form-control form-control-user" style="margin-top:1px">
									</td>																	
								</tr>
							</table>
						</td>
				...
				<div id="gridBlrSchmap" style="padding-top:1px; width:1000px; height:600px;"></div>
