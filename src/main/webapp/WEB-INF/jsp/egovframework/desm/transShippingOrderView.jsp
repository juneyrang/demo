...
<%
    ...
    String transShippingOrderViewJs = "/resources/scripts/transShippingOrderView.js?rv=" + rV;
%>
...
<script src="/resources/scripts/transShippingOrderView.js"	></script> --%>
<script src="<%= ajaxSetupJs %>"></script>
<script src="<%= transShippingOrderViewJs %>"></script>
		...
		<div class="card-body-grid" style="vertical-align: middle; ">
			...
			<div class="table-responsive" style="vertical-align: middle; ">
						...
						<td width="100%">
							<table id="tblSearchBox" style="height: 43px;border : 0">		
								...
								<tr>
									...
									<td style="text-align: right; padding-right : 4px">
										<label class="" style="">Cargo Ready Date</label>
									</td>
									<td >
								...
								<tr>
									<td style="text-align: right; padding-right : 4px">
										<label class="" style="">운송요청 상태</label>
									</td>	
									<td>
									...
									<td style="text-align: right; padding-right : 4px">
										<label class="" style="">운송 Type</label>
									</td>
									<td >
										<select id="selSearchTransportUType" class="form-control form-control-user" style="background-color: #B4D9FD;">
										</select>
									</td>									
									<td style="text-align: right; padding-right : 4px">
										<label class="" style="">운송방법</label>
									</td>
									<td >
										<select id="selSearchTransportBType" class="form-control form-control-user" style="background-color: #B4D9FD;">
										</select>
									</td>	
									<td >
									</td>
				...
				<div id="toolbar" style="margin-bottom: 1px; padding-right: 1px;">
					...
					<button id="btnPackageInfo" authType="R" class="btn btn-primary btn-icon-split btn-sm" role="button" style="float:right; margin-left:2px; height: 23px;">
						<span class="icon text-white-50"><i class="fas fa-pencil-alt"></i></span>
						<span class="text">Package 정보</span>
					</button>
