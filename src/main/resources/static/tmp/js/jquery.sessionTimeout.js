...
(function( $ ){
	jQuery.sessionTimeout = function( options ) {
		...
		var defaults = {
			title		 	 : '세션이 만료됩니다!',
			message          : '장시간 사용시간이 없어 세션이 곧 만료됩니다.\n 계속 사용하시려면 연결유지를 선택해주세요!',
			titleMessage     : 'Visitor Management System',
            stayConnectedBtn : '연결유지',
            logoutBtn        : '로그아웃',
