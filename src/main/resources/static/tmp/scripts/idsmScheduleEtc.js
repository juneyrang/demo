...
function initControls() {
	...
	Grids.OnRenderFinish = function(grid){
		if(grid.id == "idsmScheduleEtcMainGrid"){
			currentRow = null;
			parentNode = null;
			childNode = null;
...
function btnSearchClick() {
	...
	$.ajax({
		...
		data: {"VIEW_TYPE" : view_type, "KEY1" : $("#selSearchKey1").val(), "VALUE1" : $("#txtSearchValue1").val()
			  ...
			  ,"ISSUE_CHECK" : issue_check, "SCOPE" : "PT.HK"
		      },
		success: function (data, textStatus, jqXHR) {
...
function initTable(){
	...
	var mainGridCol = {
		"Cfg": {
			"id"				: "idsmScheduleEtcMainGrid"
			, "CfgId"			: "idsmScheduleEtcMainGridCfg"
			, "SuppressCfg"		: "0"
			, "StyleLap"		: "0"
			, "Version"			: "4"
			, "CacheTimeout" : "100"
		...
		, "Cols" : [
		...
		], "Head" : [
			{
				...
				, "PM_NAME"				: $('#gridColPerson').val()				, "PM_NAMESpan"				: "5"
				, "EM_NAME"				: ""
				, "BUYER_NAME"			: ""
				, "SM_NAME"				: ""
				, "QC_NAME"				: ""
			...
			, {
				...
				, "REMARK"		: "Memo"
				, "PM_NAME"				: $('#gridColPm').val()
				, "EM_NAME"				: $('#gridColEm').val()
				, "BUYER_NAME"			: $('#gridColBuyer').val()
				, "SM_NAME"				: $('#gridColSm').val()
				, "QC_NAME"				: $('#gridColQc').val()
			}
		]
	};
...
function btnDlgExcelUploadFileChange(event) {
	...
	var	sheetCol = ["ATTRIBUTE8", "PROJECT_NO", "TASK_NUMBER", "PRIMAVERA_ID", "TRK_ITEM_NAME1", "TRK_ITEM_NAME2", "TRK_ITEM_NAME3", "TRK_ITEM_NAME4",
					"ATTRIBUTE3", "ATTRIBUTE7", "ATTRIBUTE10", "INVOICE_NUM1", "INVOICE_NUM2", "INVOICE_NUM3", "ATTRIBUTE6", "OFFSHORE",
