 ...
 * Oracle Mobile Cloud Enterprise JavaScript SDK for Browser, Release: 18.3.3.0, E91501-01
 */
 ...
 * @mcs
 */
var MCSWebModule = /** @class */ (function (_super) {
    __extends(MCSWebModule, _super);
    function MCSWebModule(cxa, glob) {
     ...
     * @mcs
     */
    MCSWebModule.prototype.init = function (config) {
        this._init(config); // , cxaAnalyticsTrackerParams TODO: uncomment to return cxa
        if (!!config.mobileBackend) {
            this.mobileBackend = new backend_1.Backend(this._config, this._platform, this._utils, this._syncExpress);
        }
    };
    MCSWebModule.prototype._getPlatform = function (config, utils) {
        this._logger.debug('Create Browser platform');
        return new browser_platform_1.BrowserPlatform(config, utils, navigator);
    };
    return MCSWebModule;
}(mcs_module_1.MCSModule));
exports.MCSWebModule = MCSWebModule;
MCSGlobal = MCSWebModule;
