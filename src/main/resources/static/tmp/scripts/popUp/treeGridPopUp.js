...
function initControls() {
	...
	initDatePicker("date11");
	initDatePicker("date22");
	initDatePicker("date33");			

	initDatePicker("date111");
	initDatePicker("date222");
	initDatePicker("date333");	
	
	initDatePicker("date1111");
	initDatePicker("date2222");
	initDatePicker("date3333");	
	
	initDatePicker("date11111");
	initDatePicker("date22222");
	initDatePicker("date33333");	
	
	
	initDatePicker("iDate1");
	initDatePicker("iDate11");
	initDatePicker("iDate111");
	
	initDatePicker("aDate1");		
...
function setPopCol() {
	...
	col1 = {  
	 "Cfg" : { "ConstWidth" : "100%", "MainCol": "aa","MinTagHeight": "200","MaxHeight": "200" ,"SuppressCfg" : "1"
	 		,"Paging": "2", "PageLength": "20", "ChildParts" : "2" , "NoPager" : "1"
	 		,"LimitScroll": "23","NoHScroll" : "1"
	  },	
	...
	col2 = {  
	 "Cfg" : { "ConstWidth" : "100%", "MainCol": "aa","MinTagHeight": "200","MaxHeight": "200" ,"SuppressCfg" : "1"
	   ...
	   "Head" : [{"Kind":"Header","id" : "Header","Spanned":"1","PanelRowSpan"  : "2",
	   				"aa": "담당", "aaRowSpan"  : "2",
	   				"bb": "R&R(일정)",  "bbSpan"  : "2",
	   				"cc": "",
	   				"dd": "담당자명", "ddRowSpan"  : "2",
	   				"ee": "담당자부서" , "eeRowSpan"  : "2"
	   			},
	   			{"Kind":"Header","Spanned":"1",
	   				"aa": "담당",
	   				"bb": "관리",
	   				"cc": "조회",
	   				"dd": "담당자명",
