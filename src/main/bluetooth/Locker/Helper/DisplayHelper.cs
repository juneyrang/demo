...
namespace Locker.Bluetooth.Helper
{
    ...
    public static class DisplayHelper
    {
        public static string GetServiceName(GattDeviceService service)
        {
            if (IsSigDefinedUuid(service.Uuid))
            {
                ...
                Debug.WriteLine($"GetServiceName Uuid : {service.Uuid} - {Utilities.ConvertUuidToShortId(service.Uuid).ToString()}");
        ...
        public static string GetCharacteristicName(GattCharacteristic characteristic)
        {
            if (IsSigDefinedUuid(characteristic.Uuid))
            {
                ...
                Debug.WriteLine($"GetCharacteristicName Uuid : {characteristic.Uuid} - {Utilities.ConvertUuidToShortId(characteristic.Uuid).ToString()}");
    ...
    public enum LockerCallType : ushort
    {
        None = 0,
        Token = 1,
        OpenLock = 2
